...
// Function to determine the allowable braking torque at the ed/brakeTime operation point
function allowableBrakingTorque (ed, brakeTime) {
  let tbLineAbove;
