...
function displayResistorTransistorSelection(cr700Result, transistorResults, resistorResults, minR, maxR, power) {
    ...
    var driveCardTitle = document.createElement("h6");
    ...
    if (transistorResults) {
        ...
        var transistorCardTitle = document.createElement("h6");
    ...
    var resistorCardTitle = document.createElement("h6");
...
function calculateResult() {
    ...
    if (CR700selection) {
        let resistorResults = calculateResistors(hoist.minR, hoist.maxR, hoist.averageBrakePower(), hoist.dutyCycle, getdutyCyleTime(hoist.maxBrakePower()), hoist.dutyCycle)
